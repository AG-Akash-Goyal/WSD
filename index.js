...
app.post('/new', (req,res) => {
    ...
    var resp = req.body
    console.log(resp['id'])
    connection.query("INSERT into " + tbl + " VALUES (" + resp['Emp_ID'] + ",\'" + resp['Emp_Name'] + "\',\'" + resp['Emp_Designationmail'] + "\',\'" + resp['Emp_Department'] + "\'," + resp['Emp_Salary'] + ",\'" + resp['Emp_Location'] + "\')", function (err, result) {
        if (err) throw err;
        console.log("Result: " + JSON.stringify(result));
        res.end(JSON.stringify(result))
    });
